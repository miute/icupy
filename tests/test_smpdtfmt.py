...
def test_api():
    ...
    # UnicodeString &SimpleDateFormat::toLocalizedPattern(
    ...
    # void SimpleDateFormat::applyLocalizedPattern(
    ...
    # UnicodeString &SimpleDateFormat::toPattern(UnicodeString &result)
    string = fmt2.to_pattern(result)
    assert isinstance(string, UnicodeString)
    assert id(result) == id(string)
    assert result == "yyyy.MM.dd G 'at' HH:mm:ss z"

    # void SimpleDateFormat::applyPattern(const UnicodeString &pattern)
    ...
    # UDate SimpleDateFormat::get2DigitYearStart(UErrorCode &status)
    d = fmt2.get_2digit_year_start()
    assert isinstance(d, float)

    # void SimpleDateFormat::set2DigitYearStart(UDate d, UErrorCode &status)
    fmt2.set_2digit_year_start(d)

    # const DateFormatSymbols *SimpleDateFormat::getDateFormatSymbols(void)
    sym = fmt2.get_date_format_symbols()
    assert isinstance(sym, DateFormatSymbols)

    # void SimpleDateFormat::setDateFormatSymbols(
...
def test_format():
    ...
    # [2]
    # UnicodeString &SimpleDateFormat::format(
    #       Calendar &cal,
...
def test_get_context():
    ...
    # void SimpleDateFormat::setContext(
...
def test_parse():
    ...
    # [1]
    # void SimpleDateFormat::parse(const UnicodeString &text,
    #                              Calendar &cal,
    #                              ParsePosition &pos)
    cal = GregorianCalendar(tz, locale)
    cal.clear()
...
def test_parse_object():
    ...
    fmt.parse_object(UnicodeString("1996.07.10 AD at 15:08:56 PDT"),
                     result,
                     parse_pos)
    ...
    result = Formattable()
    parse_pos = ParsePosition(0)
    fmt.parse_object("1996.07.10 AD at 15:08:56 PDT",
                     result,
                     parse_pos)
    assert parse_pos.get_error_index() == -1
    assert result.get_type() == Formattable.DATE
...
def test_simple_date_format():
    assert issubclass(SimpleDateFormat, (DateFormat, Format))
    locale = Locale.get_english()
    ...
    #       UErrorCode &status
    # )
    fmt3 = SimpleDateFormat(UnicodeString("yyyy.MM.dd G 'at' HH:mm:ss z"),
                            UnicodeString("y=hebr;d=thai;s=arab"))
    fmt3a = SimpleDateFormat("yyyy.MM.dd G 'at' HH:mm:ss z",
                             UnicodeString("y=hebr;d=thai;s=arab"))
    fmt3b = SimpleDateFormat(UnicodeString("yyyy.MM.dd G 'at' HH:mm:ss z"),
                             "y=hebr;d=thai;s=arab")
    fmt3c = SimpleDateFormat("yyyy.MM.dd G 'at' HH:mm:ss z",
                             "y=hebr;d=thai;s=arab")
    ...
    #       UErrorCode &status
    # )
    fmt4 = SimpleDateFormat(UnicodeString("yyyy.MM.dd G 'at' HH:mm:ss z"),
                            locale)
    fmt4a = SimpleDateFormat("yyyy.MM.dd G 'at' HH:mm:ss z",
                             locale)
    assert fmt4 == fmt4a
    assert fmt4 != fmt1
    ...
    #       UErrorCode &status
    # )
    fmt5 = SimpleDateFormat(UnicodeString("yyyy.MM.dd G 'at' HH:mm:ss z"),
                            UnicodeString("y=hebr;d=thai;s=arab"),
                            locale)
    fmt5a = SimpleDateFormat("yyyy.MM.dd G 'at' HH:mm:ss z",
                             UnicodeString("y=hebr;d=thai;s=arab"),
                             locale)
    fmt5b = SimpleDateFormat(UnicodeString("yyyy.MM.dd G 'at' HH:mm:ss z"),
                             "y=hebr;d=thai;s=arab",
                             locale)
    fmt5c = SimpleDateFormat("yyyy.MM.dd G 'at' HH:mm:ss z",
                             "y=hebr;d=thai;s=arab",
                             locale)
    ...
    fmt7 = SimpleDateFormat(UnicodeString("yyyy.MM.dd G 'at' HH:mm:ss z"),
                            format_data)
    fmt7a = SimpleDateFormat("yyyy.MM.dd G 'at' HH:mm:ss z",
                             format_data)
    assert fmt7 == fmt7a
    assert fmt7 != fmt1
