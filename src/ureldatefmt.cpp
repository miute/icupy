...
void init_ureldatefmt(py::module &m) {
  ...
  py::enum_<UDateRelativeDateTimeFormatterStyle>(
      m, "UDateRelativeDateTimeFormatterStyle", py::arithmetic(),
      "The formatting style.")
      .value("UDAT_STYLE_LONG", UDAT_STYLE_LONG, "Everything spelled out.")
      .value("UDAT_STYLE_SHORT", UDAT_STYLE_SHORT,
             "Abbreviations used when possible.")
      .value("UDAT_STYLE_NARROW", UDAT_STYLE_NARROW,
  ...
  py::enum_<URelativeDateTimeFormatterField>(
      ...
      .value("UDAT_REL_LITERAL_FIELD", UDAT_REL_LITERAL_FIELD,
             "Represents a literal text string, like \"tomorrow\" or \"days "
             "ago\".")
  ...
  //
  py::enum_<URelativeDateTimeUnit>(
      m, "URelativeDateTimeUnit", py::arithmetic(),
      "Represents the unit for formatting a relative date.\n\n"
      "e.g. \"in 5 days\" or \"next year\"")
      .value("UDAT_REL_UNIT_YEAR", UDAT_REL_UNIT_YEAR,
             "Specifies that relative unit is year, e.g. \"last year\", \"in 5 "
             "years\".")
      ...
      .value("UDAT_REL_UNIT_MONTH", UDAT_REL_UNIT_MONTH,
             "Specifies that relative unit is month, e.g. \"last month\", \"in "
             "5 months\".")
      .value("UDAT_REL_UNIT_WEEK", UDAT_REL_UNIT_WEEK,
             "Specifies that relative unit is week, e.g. \"last week\", \"in 5 "
             "weeks\".")
      .value("UDAT_REL_UNIT_DAY", UDAT_REL_UNIT_DAY,
             "Specifies that relative unit is day, e.g. \"yesterday\", \"in 5 "
             "days\".")
      .value("UDAT_REL_UNIT_HOUR", UDAT_REL_UNIT_HOUR,
             "Specifies that relative unit is hour, e.g. \"1 hour ago\", \"in "
             "5 hours\".")
