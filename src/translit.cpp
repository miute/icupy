...
void init_translit(py::module &m) {
  ...
  tl.def_static(
      ...
      py::arg("index"), py::arg("source"), py::arg("target"),
      py::arg("result"));
  ...
  tl.def("get_filter", &Transliterator::getFilter,
         py::return_value_policy::reference);

  tl.def("get_id", &Transliterator::getID);

  tl.def("get_maximum_context_length",
  ...
  tl.def("orphan_filter", &Transliterator::orphanFilter,
         py::return_value_policy::reference);
