...
void init_uregion(py::module &m) {
  ...
  py::enum_<URegionType>(m, "URegionType", py::arithmetic(),
                         "*URegionType* is an enumeration defining the "
                         "different types of regions.\n\n"
                         "Current possible values are *URGN_WORLD*, "
                         "*URGN_CONTINENT*, *URGN_SUBCONTINENT*, "
                         "*URGN_TERRITORY*, *URGN_GROUPING*, "
                         "*URGN_DEPRECATED*, and *URGN_UNKNOWN*.")
      .value("URGN_UNKNOWN", URGN_UNKNOWN,
      ...
      .value("URGN_SUBCONTINENT", URGN_SUBCONTINENT,
      ...
      .value("URGN_DEPRECATED", URGN_DEPRECATED,
             ...
             "usually due to a country splitting into "
