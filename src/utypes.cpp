...
void init_utypes(py::module &m) {
  ...
  py::enum_<UErrorCode>(
      ...
      .value("U_ERROR_WARNING_START", U_ERROR_WARNING_START,
      ...
      .value("U_STATE_OLD_WARNING", U_STATE_OLD_WARNING,
             ...
             "Expect performance/memory usage "
      ...
      .value("U_SORT_KEY_TOO_SHORT_WARNING", U_SORT_KEY_TOO_SHORT_WARNING,
             "Number of levels requested in *get_bound* is higher than the "
      ...
      .value("U_DIFFERENT_UCA_VERSION", U_DIFFERENT_UCA_VERSION,
             ...
             "collator image version, so the collator was "
      ...
      .value("U_ILLEGAL_ARGUMENT_ERROR", U_ILLEGAL_ARGUMENT_ERROR,
             "Start of codes indicating failure.")
      .value("U_MISSING_RESOURCE_ERROR", U_MISSING_RESOURCE_ERROR,
             "The requested resource cannot be found.")
      .value("U_INVALID_FORMAT_ERROR", U_INVALID_FORMAT_ERROR,
             "Data format is not what is expected.")
      .value("U_FILE_ACCESS_ERROR", U_FILE_ACCESS_ERROR,
             "The requested file cannot be found.")
      .value("U_INTERNAL_PROGRAM_ERROR", U_INTERNAL_PROGRAM_ERROR,
             "Indicates a bug in the library code.")
      .value("U_MESSAGE_PARSE_ERROR", U_MESSAGE_PARSE_ERROR,
             "Unable to parse a message (message format).")
      .value("U_MEMORY_ALLOCATION_ERROR", U_MEMORY_ALLOCATION_ERROR,
             "Memory allocation error.")
      .value("U_INDEX_OUTOFBOUNDS_ERROR", U_INDEX_OUTOFBOUNDS_ERROR,
             "Trying to access the index that is out of bounds.")
      .value("U_PARSE_ERROR", U_PARSE_ERROR,
      ...
      .value("U_INVALID_CHAR_FOUND", U_INVALID_CHAR_FOUND,
             ...
             "Invalid character.")
      .value("U_TRUNCATED_CHAR_FOUND", U_TRUNCATED_CHAR_FOUND,
      ...
      .value("U_ILLEGAL_CHAR_FOUND", U_ILLEGAL_CHAR_FOUND,
             ...
             "input units.")
      .value("U_INVALID_TABLE_FORMAT", U_INVALID_TABLE_FORMAT,
             "Conversion table file found, but corrupted.")
      .value("U_INVALID_TABLE_FILE", U_INVALID_TABLE_FILE,
             "Conversion table file not found.")
      .value("U_BUFFER_OVERFLOW_ERROR", U_BUFFER_OVERFLOW_ERROR,
             "A result would not fit in the supplied buffer.")
      .value("U_UNSUPPORTED_ERROR", U_UNSUPPORTED_ERROR,
      ...
      .value("U_ILLEGAL_ESCAPE_SEQUENCE", U_ILLEGAL_ESCAPE_SEQUENCE,
      ...
      .value("U_TOO_MANY_ALIASES_ERROR", U_TOO_MANY_ALIASES_ERROR,
             ...
             "resource. It is very possible that a circular "
      ...
      .value("U_INVARIANT_CONVERSION_ERROR", U_INVARIANT_CONVERSION_ERROR,
             "Unable to convert a UChar* string to char* with the invariant "
             "converter.")
      ...
      .value("U_USELESS_COLLATOR_ERROR", U_USELESS_COLLATOR_ERROR,
             "Collator is options only and no base is specified.")
      .value("U_NO_WRITE_PERMISSION", U_NO_WRITE_PERMISSION,
      ...
      .value("U_INPUT_TOO_LONG_ERROR", U_INPUT_TOO_LONG_ERROR,
             ...
             "because it may lead to problems such as "
             "excessive processing time, stack depth, or heap memory "
             "requirements.")
#endif // (U_ICU_VERSION_MAJOR_NUM >= 68)
      .value("U_STANDARD_ERROR_LIMIT", U_STANDARD_ERROR_LIMIT,
             "**Deprecated:** ICU 58 The numeric value may change over time, "
             "see ICU ticket #12420.")
      .value("U_BAD_VARIABLE_DEFINITION", U_BAD_VARIABLE_DEFINITION,
             "Missing '$' or duplicate variable name.")
      .value("U_PARSE_ERROR_START", U_PARSE_ERROR_START,
             "Start of Transliterator errors.")
      .value("U_MALFORMED_RULE", U_MALFORMED_RULE,
             "Elements of a rule are misplaced.")
      .value("U_MALFORMED_SET", U_MALFORMED_SET,
             "A UnicodeSet pattern is invalid.")
      .value("U_MALFORMED_SYMBOL_REFERENCE", U_MALFORMED_SYMBOL_REFERENCE,
             "UNUSED as of ICU 2.4.")
      .value("U_MALFORMED_UNICODE_ESCAPE", U_MALFORMED_UNICODE_ESCAPE,
      ...
      .value("U_MISMATCHED_SEGMENT_DELIMITERS", U_MISMATCHED_SEGMENT_DELIMITERS,
             "UNUSED as of ICU 2.4.")
      .value("U_MISPLACED_ANCHOR_START", U_MISPLACED_ANCHOR_START,
             "A start anchor appears at an illegal position.")
      .value("U_MISPLACED_CURSOR_OFFSET", U_MISPLACED_CURSOR_OFFSET,
             "A cursor offset occurs at an illegal position.")
      .value("U_MISPLACED_QUANTIFIER", U_MISPLACED_QUANTIFIER,
             "A quantifier appears after a segment close delimiter.")
      .value("U_MISSING_OPERATOR", U_MISSING_OPERATOR,
             "A rule contains no operator.")
      .value("U_MISSING_SEGMENT_CLOSE", U_MISSING_SEGMENT_CLOSE,
             "UNUSED as of ICU 2.4.")
      .value("U_MULTIPLE_ANTE_CONTEXTS", U_MULTIPLE_ANTE_CONTEXTS,
             "More than one ante context.")
      .value("U_MULTIPLE_CURSORS", U_MULTIPLE_CURSORS, "More than one cursor.")
      .value("U_MULTIPLE_POST_CONTEXTS", U_MULTIPLE_POST_CONTEXTS,
             "More than one post context.")
      .value("U_TRAILING_BACKSLASH", U_TRAILING_BACKSLASH,
      ...
      .value("U_UNQUOTED_SPECIAL", U_UNQUOTED_SPECIAL,
             "A special character was not quoted or escaped.")
      .value("U_UNTERMINATED_QUOTE", U_UNTERMINATED_QUOTE,
             "A closing single quote is missing.")
      .value("U_RULE_MASK_ERROR", U_RULE_MASK_ERROR,
      ...
      .value("U_INVALID_PROPERTY_PATTERN", U_INVALID_PROPERTY_PATTERN,
             "UNUSED as of ICU 2.4.")
      .value("U_MALFORMED_PRAGMA", U_MALFORMED_PRAGMA,
             "A 'use' pragma is invalid.")
      .value("U_UNCLOSED_SEGMENT", U_UNCLOSED_SEGMENT,
             "A closing ')' is missing.")
      .value("U_ILLEGAL_CHAR_IN_SEGMENT", U_ILLEGAL_CHAR_IN_SEGMENT,
             "UNUSED as of ICU 2.4.")
      ...
      .value("U_ILLEGAL_CHARACTER", U_ILLEGAL_CHARACTER,
      ...
      .value("U_INVALID_ID", U_INVALID_ID,
             "A \"::id\" rule specifies an unknown transliterator.")
      .value("U_INVALID_FUNCTION", U_INVALID_FUNCTION,
             "A \"&fn()\" rule specifies an unknown transliterator.")
      .value("U_PARSE_ERROR_LIMIT", U_PARSE_ERROR_LIMIT,
             "**Deprecated:** ICU 58 The numeric value may change over time, "
             "see ICU ticket #12420.")
      .value("U_UNEXPECTED_TOKEN", U_UNEXPECTED_TOKEN,
             "Syntax error in format pattern.")
      .value("U_FMT_PARSE_ERROR_START", U_FMT_PARSE_ERROR_START,
      ...
      .value("U_MULTIPLE_PAD_SPECIFIERS", U_MULTIPLE_PAD_SPECIFIERS,
             "More than one pad symbol in number pattern.")
      .value("U_PATTERN_SYNTAX_ERROR", U_PATTERN_SYNTAX_ERROR,
             "Syntax error in format pattern.")
      .value("U_ILLEGAL_PAD_POSITION", U_ILLEGAL_PAD_POSITION,
             "Pad symbol misplaced in number pattern.")
      .value("U_UNMATCHED_BRACES", U_UNMATCHED_BRACES,
             "Braces do not match in message pattern.")
      .value("U_UNSUPPORTED_PROPERTY", U_UNSUPPORTED_PROPERTY,
             "UNUSED as of ICU 2.4.")
      .value("U_UNSUPPORTED_ATTRIBUTE", U_UNSUPPORTED_ATTRIBUTE,
             "UNUSED as of ICU 2.4.")
      .value("U_ARGUMENT_TYPE_MISMATCH", U_ARGUMENT_TYPE_MISMATCH,
             "Argument name and argument index mismatch in MessageFormat "
             "functions.")
      .value("U_DUPLICATE_KEYWORD", U_DUPLICATE_KEYWORD,
             "Duplicate keyword in *PluralFormat*.")
      .value("U_UNDEFINED_KEYWORD", U_UNDEFINED_KEYWORD,
             "Undefined Plural keyword.")
      .value("U_DEFAULT_KEYWORD_MISSING", U_DEFAULT_KEYWORD_MISSING,
      ...
      .value("U_FORMAT_INEXACT_ERROR", U_FORMAT_INEXACT_ERROR,
             ...
             "ROUND_UNNECESSARY @stable ICU 4.8.")
      ...
      .value("U_NUMBER_SKELETON_SYNTAX_ERROR", U_NUMBER_SKELETON_SYNTAX_ERROR,
             ...
             "UNumberFormatter was invalid or contained a "
             "syntax error.")
#endif // (U_ICU_VERSION_MAJOR_NUM >= 62)
      .value("U_FMT_PARSE_ERROR_LIMIT", U_FMT_PARSE_ERROR_LIMIT,
             "**Deprecated:** ICU 58 The numeric value may change over time, "
             "see ICU ticket #12420.")
      .value("U_BRK_INTERNAL_ERROR", U_BRK_INTERNAL_ERROR,
             "An internal error (bug) was detected.")
      .value("U_BRK_ERROR_START", U_BRK_ERROR_START,
      ...
      .value("U_BRK_SEMICOLON_EXPECTED", U_BRK_SEMICOLON_EXPECTED,
             "Missing ';' at the end of a RBBI rule.")
      .value("U_BRK_RULE_SYNTAX", U_BRK_RULE_SYNTAX,
             "Syntax error in RBBI rule.")
      .value("U_BRK_UNCLOSED_SET", U_BRK_UNCLOSED_SET,
             "UnicodeSet writing an RBBI rule missing a closing ']'.")
      .value("U_BRK_ASSIGN_ERROR", U_BRK_ASSIGN_ERROR,
             "Syntax error in RBBI rule assignment statement.")
      .value("U_BRK_VARIABLE_REDFINITION", U_BRK_VARIABLE_REDFINITION,
             "RBBI rule $Variable redefined.")
      .value("U_BRK_MISMATCHED_PAREN", U_BRK_MISMATCHED_PAREN,
      ...
      .value("U_BRK_UNDEFINED_VARIABLE", U_BRK_UNDEFINED_VARIABLE,
             "Use of an undefined $Variable in an RBBI rule.")
      .value("U_BRK_INIT_ERROR", U_BRK_INIT_ERROR,
             "Initialization failure.  Probable missing ICU Data.")
      .value("U_BRK_RULE_EMPTY_SET", U_BRK_RULE_EMPTY_SET,
             "Rule contains an empty Unicode Set.")
      .value("U_BRK_UNRECOGNIZED_OPTION", U_BRK_UNRECOGNIZED_OPTION,
             "!!option in RBBI rules not recognized.")
      .value("U_BRK_MALFORMED_RULE_TAG", U_BRK_MALFORMED_RULE_TAG,
             "The {nnn} tag on a rule is malformed.")
      .value("U_BRK_ERROR_LIMIT", U_BRK_ERROR_LIMIT,
             "**Deprecated:** ICU 58 The numeric value may change over time, "
             "see ICU ticket #12420.")
      .value("U_REGEX_INTERNAL_ERROR", U_REGEX_INTERNAL_ERROR,
             "An internal error (bug) was detected.")
      .value("U_REGEX_ERROR_START", U_REGEX_ERROR_START,
             "Start of codes indicating Regexp failures.")
      .value("U_REGEX_RULE_SYNTAX", U_REGEX_RULE_SYNTAX,
             "Syntax error in regexp pattern.")
      .value("U_REGEX_INVALID_STATE", U_REGEX_INVALID_STATE,
      ...
      .value("U_REGEX_PROPERTY_SYNTAX", U_REGEX_PROPERTY_SYNTAX,
             "Incorrect Unicode property.")
      .value("U_REGEX_UNIMPLEMENTED", U_REGEX_UNIMPLEMENTED,
             "Use of regexp feature that is not yet implemented.")
      .value("U_REGEX_MISMATCHED_PAREN", U_REGEX_MISMATCHED_PAREN,
             "Incorrectly nested parentheses in regexp pattern.")
      .value("U_REGEX_NUMBER_TOO_BIG", U_REGEX_NUMBER_TOO_BIG,
             "Decimal number is too large.")
      .value("U_REGEX_BAD_INTERVAL", U_REGEX_BAD_INTERVAL,
             "Error in {min,max} interval.")
      .value("U_REGEX_MAX_LT_MIN", U_REGEX_MAX_LT_MIN,
             "In {min,max}, max is less than min.")
      .value("U_REGEX_INVALID_BACK_REF", U_REGEX_INVALID_BACK_REF,
             "Back-reference to a non-existent capture group.")
      .value("U_REGEX_INVALID_FLAG", U_REGEX_INVALID_FLAG,
      ...
      .value("U_REGEX_OCTAL_TOO_BIG", U_REGEX_OCTAL_TOO_BIG,
      ...
      .value("U_REGEX_INVALID_RANGE", U_REGEX_INVALID_RANGE,
             "In a character range [x-y], x is greater than y.")
      .value("U_REGEX_STACK_OVERFLOW", U_REGEX_STACK_OVERFLOW,
             "Regular expression backtrack stack overflow.")
      .value("U_REGEX_TIME_OUT", U_REGEX_TIME_OUT,
             "Maximum allowed match time exceeded.")
      .value("U_REGEX_STOPPED_BY_CALLER", U_REGEX_STOPPED_BY_CALLER,
             "Matching operation aborted by user callback fn.")
#if (U_ICU_VERSION_MAJOR_NUM >= 55)
      .value("U_REGEX_PATTERN_TOO_BIG", U_REGEX_PATTERN_TOO_BIG,
      ...
      .value("U_PLUGIN_ERROR_START", U_PLUGIN_ERROR_START,
             "Start of codes indicating plugin failures.")
      .value("U_PLUGIN_TOO_HIGH", U_PLUGIN_TOO_HIGH,
             "The plugin's level is too high to be loaded right now.")
      .value(
          "U_PLUGIN_DIDNT_SET_LEVEL", U_PLUGIN_DIDNT_SET_LEVEL,
