...
void init_displayoptions(py::module &m) {
  ...
  bld.def("set_capitalization", &DisplayOptions::Builder::setCapitalization,
          py::arg("capitalization"));

  bld.def("set_display_length", &DisplayOptions::Builder::setDisplayLength,
          py::arg("display_length"));

  bld.def("set_grammatical_case", &DisplayOptions::Builder::setGrammaticalCase,
          py::arg("grammatical_case"));

  bld.def("set_name_style", &DisplayOptions::Builder::setNameStyle,
          py::arg("name_style"));

  bld.def("set_noun_class", &DisplayOptions::Builder::setNounClass,
          py::arg("noun_class"));

  bld.def("set_plural_category", &DisplayOptions::Builder::setPluralCategory,
          py::arg("plural_category"));

  bld.def("set_substitute_handling",
          &DisplayOptions::Builder::setSubstituteHandling,
          py::arg("substitute_handling"));
