...
void init_udatpg(py::module &m) {
  ...
  //
  py::native_enum<UDateTimePatternConflict>(m, "UDateTimePatternConflict",
                                            "enum.IntEnum", R"doc(
Status return values from :meth:`DateTimePatternGenerator.add_pattern`.
  ...
  //
  py::native_enum<UDateTimePatternField>(m, "UDateTimePatternField",
                                         "enum.IntEnum",
                                         R"doc(
...
overlap because some fields are merged for the date/time pattern generator.
  ...
  //
  py::native_enum<UDateTimePatternMatchOptions>(
      m, "UDateTimePatternMatchOptions", "enum.IntEnum", R"doc(
...
:meth:`DateTimePatternGenerator.replace_field_types`.
  ...
  //
  py::native_enum<UDateTimePGDisplayWidth>(m, "UDateTimePGDisplayWidth",
                                           "enum.IntEnum", R"doc(
