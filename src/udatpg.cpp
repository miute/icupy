...
void init_udatpg(py::module &m) {
  ...
  //
  py::enum_<UDateTimePatternConflict>(
      m, "UDateTimePatternConflict", py::arithmetic(),
  ...
  py::enum_<UDateTimePatternField>(
      ...
      "Field number constants for *udatpg_get_append_item_formats()* and "
      "similar functions.\n\n"
      "These constants are separate from *UDateFormatField* despite semantic "
      "overlap because some fields are merged "
