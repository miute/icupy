...
void init_decimfmt(py::module & /* m */,
                   py::class_<DecimalFormat, NumberFormat> &df) {
  //
  ...
  df.def(
      ...
      .def(
          ...
          py::init([](const icupy::UnicodeStringVariant &pattern) {
            ErrorCode error_code;
            auto result = std::make_unique<DecimalFormat>(
      ...
      .def(
          ...
          py::init([](const icupy::UnicodeStringVariant &pattern,
            ...
            ErrorCode error_code;
            auto result = std::make_unique<DecimalFormat>(
                icupy::to_unistr(pattern), symbols, error_code);
            if (error_code.isFailure()) {
              throw icupy::ICUError(error_code);
            }
            return result;
  ...
  df.def(
      "__deepcopy__",
      [](const DecimalFormat &self, py::dict & /* memo */) {
        return self.clone();
      },
      py::arg("memo"));

  // FIXME: Implement "void
  //  icu::DecimalFormat::adoptCurrencyPluralInfo(CurrencyPluralInfo *toAdopt)".

  // FIXME: Implement "void
  //  icu::DecimalFormat::adoptDecimalFormatSymbols(DecimalFormatSymbols
  //  *symbolsToAdopt)".
  ...
  df.def(
      ...
      .def(
          ...
          [](DecimalFormat &self, const icupy::UnicodeStringVariant &pattern,
            ...
            ErrorCode error_code;
            self.applyLocalizedPattern(icupy::to_unistr(pattern), parse_error,
                                       error_code);
            if (error_code.isFailure()) {
              throw icupy::ICUError(error_code);
            }
  ...
  df.def("are_significant_digits_used",
         [](const DecimalFormat &self) -> py::bool_ {
           return self.areSignificantDigitsUsed();
         });
  ...
  df.def("get_currency_plural_info", &DecimalFormat::getCurrencyPluralInfo,
  ...
  df.def("get_decimal_format_symbols", &DecimalFormat::getDecimalFormatSymbols,
         py::return_value_policy::reference);
  ...
  df.def("get_maximum_significant_digits",
         &DecimalFormat::getMaximumSignificantDigits);

  df.def("get_minimum_exponent_digits",
         &DecimalFormat::getMinimumExponentDigits);

#if (U_ICU_VERSION_MAJOR_NUM >= 64)
  df.def("get_minimum_grouping_digits",
         &DecimalFormat::getMinimumGroupingDigits);
#endif // (U_ICU_VERSION_MAJOR_NUM >= 64)

  df.def("get_minimum_significant_digits",
         &DecimalFormat::getMinimumSignificantDigits);
  ...
  df.def("get_negative_prefix", &DecimalFormat::getNegativePrefix,
         py::arg("result"));

  df.def("get_negative_suffix", &DecimalFormat::getNegativeSuffix,
         py::arg("result"));
  ...
  df.def("get_positive_prefix", &DecimalFormat::getPositivePrefix,
         py::arg("result"));

  df.def("get_positive_suffix", &DecimalFormat::getPositiveSuffix,
         py::arg("result"));

  df.def("get_rounding_increment", &DecimalFormat::getRoundingIncrement);

  df.def("get_secondary_grouping_size",
         &DecimalFormat::getSecondaryGroupingSize);

#if (U_ICU_VERSION_MAJOR_NUM >= 54)
  df.def("is_decimal_pattern_match_required",
         [](const DecimalFormat &self) -> py::bool_ {
           return self.isDecimalPatternMatchRequired();
         });
#endif // (U_ICU_VERSION_MAJOR_NUM >= 54)

  df.def("is_decimal_separator_always_shown",
         [](const DecimalFormat &self) -> py::bool_ {
           return self.isDecimalSeparatorAlwaysShown();
         });

  df.def("is_exponent_sign_always_shown",
         [](const DecimalFormat &self) -> py::bool_ {
           return self.isExponentSignAlwaysShown();
         });

#if (U_ICU_VERSION_MAJOR_NUM >= 64)
  df.def("is_format_fail_if_more_than_max_digits",
         [](const DecimalFormat &self) -> py::bool_ {
           return self.isFormatFailIfMoreThanMaxDigits();
         });

  df.def("is_parse_case_sensitive", [](const DecimalFormat &self) -> py::bool_ {
    return self.isParseCaseSensitive();
  });

  df.def("is_parse_no_exponent", [](const DecimalFormat &self) -> py::bool_ {
    return self.isParseNoExponent();
  });
#endif // (U_ICU_VERSION_MAJOR_NUM >= 64)

  df.def("is_scientific_notation", [](const DecimalFormat &self) -> py::bool_ {
    return self.isScientificNotation();
  });

#if (U_ICU_VERSION_MAJOR_NUM >= 64)
  df.def("is_sign_always_shown", [](const DecimalFormat &self) -> py::bool_ {
    return self.isSignAlwaysShown();
  });
#endif // (U_ICU_VERSION_MAJOR_NUM >= 64)
  ...
  df.def(
      "set_attribute",
      [](DecimalFormat &self, UNumberFormatAttribute attr,
         int32_t new_value) -> DecimalFormat & {
        ErrorCode error_code;
  ...
  df.def("set_currency_plural_info", &DecimalFormat::setCurrencyPluralInfo,
         py::arg("info"));
  ...
  df.def("set_decimal_format_symbols", &DecimalFormat::setDecimalFormatSymbols,
         py::arg("symbols"));

#if (U_ICU_VERSION_MAJOR_NUM >= 54)
  df.def(
      "set_decimal_pattern_match_required",
      [](DecimalFormat &self, py::bool_ new_value) {
        self.setDecimalPatternMatchRequired(new_value);
      },
      py::arg("new_value"));
#endif // (U_ICU_VERSION_MAJOR_NUM >= 54)
  ...
  df.def(
      ...
      [](DecimalFormat &self, py::bool_ new_value) {
        self.setDecimalSeparatorAlwaysShown(new_value);
      },
      py::arg("new_value"));
  ...
  df.def(
      ...
      [](DecimalFormat &self, py::bool_ new_value) {
        self.setExponentSignAlwaysShown(new_value);
      },
  ...
  df.def(
      ...
      [](DecimalFormat &self, py::bool_ value) {
        self.setFormatFailIfMoreThanMaxDigits(value);
      },
      py::arg("value"));
#endif // (U_ICU_VERSION_MAJOR_NUM >= 64)
  ...
  df.def("set_grouping_size", &DecimalFormat::setGroupingSize,
         py::arg("new_value"));
  ...
  df.def("set_minimum_grouping_digits",
         &DecimalFormat::setMinimumGroupingDigits, py::arg("new_value"));
#endif // (U_ICU_VERSION_MAJOR_NUM >= 64)
...
#if (U_ICU_VERSION_MAJOR_NUM >= 62)
  df.def("set_multiplier_scale", &DecimalFormat::setMultiplierScale,
         py::arg("new_value"));
#endif // (U_ICU_VERSION_MAJOR_NUM >= 62)
  ...
  df.def("set_pad_position", &DecimalFormat::setPadPosition,
         py::arg("pad_pos"));

#if (U_ICU_VERSION_MAJOR_NUM >= 64)
  df.def(
      "set_parse_case_sensitive",
      [](DecimalFormat &self, py::bool_ value) {
        self.setParseCaseSensitive(value);
      },
      py::arg("value"));
#endif // (U_ICU_VERSION_MAJOR_NUM >= 64)
...
#if (U_ICU_VERSION_MAJOR_NUM >= 64)
  df.def(
      "set_parse_no_exponent",
      [](DecimalFormat &self, py::bool_ value) {
        self.setParseNoExponent(value);
      },
      py::arg("value"));
#endif // (U_ICU_VERSION_MAJOR_NUM >= 64)
  ...
  df.def("set_rounding_increment", &DecimalFormat::setRoundingIncrement,
         py::arg("new_value"));

  df.def(
      "set_scientific_notation",
      [](DecimalFormat &self, py::bool_ use_scientific) {
        self.setScientificNotation(use_scientific);
      },
      py::arg("use_scientific"));

  df.def("set_secondary_grouping_size",
         &DecimalFormat::setSecondaryGroupingSize, py::arg("new_value"));

#if (U_ICU_VERSION_MAJOR_NUM >= 64)
  df.def(
      "set_sign_always_shown",
      [](DecimalFormat &self, py::bool_ new_value) {
        self.setSignAlwaysShown(new_value);
      },
      py::arg("new_value"));
#endif // (U_ICU_VERSION_MAJOR_NUM >= 64)
  ...
  df.def("to_localized_pattern", &DecimalFormat::toLocalizedPattern,
         py::arg("result"));
