...
void init_uniset(py::module &m, py::module &h) {
  ...
  cpr.def_property_readonly(
      "range_start", [](const U_HEADER_ONLY_NAMESPACE::CodePointRange &self) {
        return self.rangeStart;
      });

  cpr.def_property_readonly(
      "range_end", [](const U_HEADER_ONLY_NAMESPACE::CodePointRange &self) {
  ...
  */
  ...
  us.def("is_bogus",
         [](const UnicodeSet &self) -> py::bool_ { return self.isBogus(); });

  us.def("is_empty",
         [](const UnicodeSet &self) -> py::bool_ { return self.isEmpty(); });
  ...
  us.def_property_readonly_static(
      "IGNORE_SPACE",
      [](const py::object &) -> int32_t { return USET_IGNORE_SPACE; });
  ...
  us.def_property_readonly_static(
      "SERIALIZED_STATIC_ARRAY_CAPACITY", [](const py::object &) -> int32_t {
