...
void init_uformattedvalue(py::module &m) {
  ...
  py::enum_<UFieldCategory>(
      ...
      "Every entry in this enum corresponds to another enum that exists in "
      "ICU.\n\n"
      "In the APIs that take a *UFieldCategory*, an int32_t type is used. "
      "Field categories having any of the top four "
      "bits turned on are reserved as private-use for external APIs "
      "implementing *FormattedValue*. This means that "
      "categories 2^28 and higher or below zero (with the highest bit turned "
      "on) are private-use and will not be used "
      ...
      .value("UFIELD_CATEGORY_LIST", UFIELD_CATEGORY_LIST,
             "For fields in *UListFormatterField* (ulistformatter.h), from ICU "
             "63.")
      .value("UFIELD_CATEGORY_RELATIVE_DATETIME",
             UFIELD_CATEGORY_RELATIVE_DATETIME,
             "For fields in *URelativeDateTimeFormatterField* (ureldatefmt.h), "
             "from ICU 64.")
