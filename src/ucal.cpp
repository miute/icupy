...
void init_ucal(py::module &m) {
  ...
  py::enum_<UCalendarDateFields>(m, "UCalendarDateFields", py::arithmetic(),
      ...
      .value("UCAL_MONTH", UCAL_MONTH,
             ...
             "This is a calendar-specific value. The first month of the year "
             "is JANUARY; the last depends on the "
             "number of months in a year.")
      .value("UCAL_WEEK_OF_YEAR", UCAL_WEEK_OF_YEAR,
             "Field number indicating the week number within the current "
             "year.\n\n  "
             "The first week of the year, as defined by "
             "*UCAL_FIRST_DAY_OF_WEEK* and *UCAL_MINIMAL_DAYS_IN_FIRST_WEEK* "
             "attributes, has value 1. Subclasses define the value of "
             "*UCAL_WEEK_OF_YEAR* for days before the first "
             "week of the year.")
      .value("UCAL_WEEK_OF_MONTH", UCAL_WEEK_OF_MONTH,
             "Field number indicating the week number within the current "
             "month.\n\n  "
             "The first week of the month, as defined by "
             "*UCAL_FIRST_DAY_OF_WEEK* and "
             "*UCAL_MINIMAL_DAYS_IN_FIRST_WEEK* attributes, has value 1. "
             "Subclasses define the value of "
      ...
      .value("UCAL_DATE", UCAL_DATE,
             ...
             "This is a synonym for DAY_OF_MONTH. The first day of the month "
             "has value 1.")
      .value("UCAL_DAY_OF_YEAR", UCAL_DAY_OF_YEAR,
             "Field number indicating the day number within the current "
             "year.\n\n  "
             "The first day of the year has value 1.")
      .value("UCAL_DAY_OF_WEEK", UCAL_DAY_OF_WEEK,
             "Field number indicating the day of the week.\n\n  "
             "This field takes values SUNDAY, MONDAY, TUESDAY, WEDNESDAY, "
             "THURSDAY, FRIDAY, and SATURDAY.")
      .value("UCAL_DAY_OF_WEEK_IN_MONTH", UCAL_DAY_OF_WEEK_IN_MONTH,
             "Field number indicating the ordinal number of the day of the "
             "week within the current month.\n\n  "
             "Together with the DAY_OF_WEEK field, this uniquely specifies a "
             "day within a month. Unlike "
             "WEEK_OF_MONTH and WEEK_OF_YEAR, this field's value does not "
             "depend on *get_first_day_of_week()* or "
             "*get_minimal_days_in_first_week()*. DAY_OF_MONTH 1 through 7 "
             ...
             "DAY_OF_WEEK_IN_MONTH 1. Negative values count back "
             "from the end of the month, so the last Sunday of a month is "
             "specified as DAY_OF_WEEK = SUNDAY, "
             "DAY_OF_WEEK_IN_MONTH = -1. Because negative values count "
             "backward they will usually be aligned "
             "differently within the month than positive values. For example, "
             "if a month has 31 days, "
             "DAY_OF_WEEK_IN_MONTH -1 will overlap DAY_OF_WEEK_IN_MONTH 5 and "
             "the end of 4.")
      .value("UCAL_AM_PM", UCAL_AM_PM,
             "Field number indicating whether the HOUR is before or after "
             "noon.\n\n  "
             "E.g., at 10:04:15.250 PM the AM_PM is PM.")
      .value(
          "UCAL_HOUR", UCAL_HOUR,
          "Field number indicating the hour of the morning or afternoon.\n\n  "
          "HOUR is used for the 12-hour clock. E.g., at 10:04:15.250 PM the "
          "HOUR is 10.")
      .value("UCAL_HOUR_OF_DAY", UCAL_HOUR_OF_DAY,
             "Field number indicating the hour of the day.\n\n  "
             "HOUR_OF_DAY is used for the 24-hour clock. E.g., at 10:04:15.250 "
      ...
      .value("UCAL_EXTENDED_YEAR", UCAL_EXTENDED_YEAR,
             ...
             "Year values indicate years AD, 1 BC = 0 "
      ...
      .value("UCAL_JULIAN_DAY", UCAL_JULIAN_DAY,
             ...
             "regards. First, it demarcates days at "
             "local zone midnight, rather than noon GMT. Second, it is a local "
             "number; that is, it depends on the "
             "local time zone. It can be thought of as a single number that "
      ...
      .value("UCAL_MILLISECONDS_IN_DAY", UCAL_MILLISECONDS_IN_DAY,
             ...
             "fields, not including the zone fields. "
             "As such, it also reflects discontinuities of those fields on DST "
             "transition days. On a day of DST onset, "
             "it will jump forward. On a day of DST cessation, it will jump "
             "backward. This reflects the fact that it "
             "must be combined with the DST_OFFSET field to obtain a unique "
             "local time value.")
      ...
      .value("UCAL_ORDINAL_MONTH", UCAL_ORDINAL_MONTH,
             "Field number indicating the month.\n\n"
             "This is a calendar-specific value. Differ from *UCAL_MONTH*, "
             "this value is continuous and unique within a "
             "year and range from 0 to 11 or 0 to 12 depending on how many "
             "months in a year, the calendar system has leap "
             "month or not, and in leap year or not. It is the ordinal "
             "position of that month in the corresponding year "
             "of the calendar. "
             ...
             "When the number of months in a year of the "
             "identified calendar is variable, a different "
             "*UCAL_ORDINAL_MONTH* value can be used for dates that are part "
             "of the same named month in different years. "
             "For example, in the Hebrew calendar, \"1 Nisan 5781\" is "
             "associated with *UCAL_ORDINAL_MONTH* value 6 while "
             "\"1 Nisan 5782\" is associated with *UCAL_ORDINAL_MONTH* value 7 "
             "because 5782 is a leap year and Nisan "
             "follows the insertion of Adar I. "
             "In Chinese calendar, \"Year 4664 Month 6 Day 2\" is associated "
             "with *UCAL_ORDINAL_MONTH* value 5 while "
             "\"Year 4665 Month 6 Day 2\" is associated with "
             "*UCAL_ORDINAL_MONTH* value 6 because 4665 is a leap year and "
             "there is an extra \"Leap Month 5\" which associated with "
             "*UCAL_ORDINAL_MONTH* value 5 before \"Month 6\" of "
             "year 4664.")
      ...
      .value("UCAL_DAY_OF_MONTH", UCAL_DAY_OF_MONTH,
             "Field number indicating the day of the month.\n\n  "
             "This is a synonym for *UCAL_DATE*. The first day of the month "
             "has value 1.")
      .export_values();
  ...
  py::enum_<UCalendarDaysOfWeek>(
      ...
      "Note: Calendar day-of-week is 1-based. Clients who create locale "
      "resources for the field of first-day-of-week "
      "should be aware of this. For instance, in US locale, first-day-of-week "
      "is set to 1, i.e., *UCAL_SUNDAY*. "
  ...
  py::enum_<UCalendarMonths>(m, "UCalendarMonths", py::arithmetic(),
      ...
      .value("UCAL_UNDECIMBER", UCAL_UNDECIMBER,
             "Value of the *UCAL_MONTH* field indicating the thirteenth month "
             "of the year.\n\n  "
  ...
  py::enum_<UCalendarType>(m, "UCalendarType", py::arithmetic(),
      ...
      .value("UCAL_TRADITIONAL", UCAL_TRADITIONAL,
             "Despite the name, *UCAL_TRADITIONAL* designates the locale's "
             "default calendar, which may be the "
  ...
  py::enum_<UCalendarWallTimeOption>(m, "UCalendarWallTimeOption",
                                     py::arithmetic(),
                                     "Options for handling ambiguous wall time "
                                     "at time zone offset transitions.")
  ...
  py::enum_<USystemTimeZoneType>(
      ...
      "*ucal_open_time_zone_id_enumeration*.")
  ...
  py::enum_<UTimeZoneLocalOption>(
      ...
      "Options used by *ucal_get_time_zone_offset_from_local* and "
      "*BasicTimeZone::get_offset_from_local()* to specify "
      "how to interpret an input time when it does not exist, or when it is "
      ...
      .value("UCAL_TZ_LOCAL_STANDARD_FORMER", UCAL_TZ_LOCAL_STANDARD_FORMER,
             ...
             "switched to/from daylight saving "
             "time.\n\n  "
             "When both sides of a time zone transition are standard time, or "
             "daylight saving time, the local time "
      ...
      .value("UCAL_TZ_LOCAL_DAYLIGHT_FORMER", UCAL_TZ_LOCAL_DAYLIGHT_FORMER,
             ...
             "time is switched to/from standard "
             "time.\n\n  "
             "When both sides of a time zone transition are standard time, or "
             "daylight saving time, the local time "
             "before the transition is used.")
