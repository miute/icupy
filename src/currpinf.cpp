...
void init_currpinf(py::module &m) {
  ...
  cpi.def(py::init([]() {
      ...
      .def(py::init([](const icupy::LocaleVariant &locale) {
             ErrorCode error_code;
             auto result = std::make_unique<CurrencyPluralInfo>(
  ...
  cpi.def(
      "__deepcopy__",
      [](const CurrencyPluralInfo &self, py::dict & /* memo */) {
        return self.clone();
      },
      py::arg("memo"));
  ...
  cpi.def(
      "__eq__",
      [](const CurrencyPluralInfo &self, const CurrencyPluralInfo &other) {
        return self == other;
      },
  ...
  cpi.def(
      ...
      [](const CurrencyPluralInfo &self,
         const icupy::UnicodeStringVariant &plural_count,
         UnicodeString &result) -> UnicodeString & {
        return self.getCurrencyPluralPattern(icupy::to_unistr(plural_count),
                                             result);
      },
  ...
  cpi.def("get_plural_rules", &CurrencyPluralInfo::getPluralRules,
          py::return_value_policy::reference);

  cpi.def(
      "set_currency_plural_pattern",
      [](CurrencyPluralInfo &self,
         const icupy::UnicodeStringVariant &plural_count,
         const icupy::UnicodeStringVariant &pattern) {
        ErrorCode error_code;
        self.setCurrencyPluralPattern(icupy::to_unistr(plural_count),
  ...
  cpi.def(
      "set_plural_rules",
      [](CurrencyPluralInfo &self,
         const icupy::UnicodeStringVariant &rule_description) {
        ErrorCode error_code;
