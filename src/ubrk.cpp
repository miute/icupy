...
void init_ubrk(py::module &m) {
  ...
  // enum ULineBreakTag
  //
  py::enum_<ULineBreakTag>(
      m, "ULineBreakTag", py::arithmetic(),
      ...
      "of a category in future releases. Applications should check for tag "
      "values falling within "
      "the range, rather than for single individual values.\n\n"
      "The numeric values of all of these constants are stable (will not "
      "change).")
  ...
  py::enum_<USentenceBreakTag>(m, "USentenceBreakTag", py::arithmetic(),
                               "Enum constants for the sentence break tags "
                               "returned by *get_rule_status()*.\n\n"
                               "A range of values is defined for each category "
                               "of sentence, to allow for further "
                               "subdivisions of a category in future releases. "
                               "Applications should check for tag "
                               "values falling within the range, rather than "
                               "for single individual values.\n\n"
                               "The numeric values of all of these constants "
                               "are stable (will not change).")
      .value("UBRK_SENTENCE_TERM", UBRK_SENTENCE_TERM,
             "Tag value for for sentences ending with a sentence terminator "
             "('.', '?', '!', etc.) character, possibly "
             "followed by a hard separator (CR, LF, PS, etc.)")
      .value(
          "UBRK_SENTENCE_TERM_LIMIT", UBRK_SENTENCE_TERM_LIMIT,
          "Upper bound for tags for sentences ended by sentence terminators.")
      .value("UBRK_SENTENCE_SEP", UBRK_SENTENCE_SEP,
             "Tag value for for sentences that do not contain an ending "
             "sentence terminator ('.', '?', '!', etc.) "
             "character, but are ended only by a hard separator (CR, LF, PS, "
             "etc.) or end of input.")
  ...
  py::enum_<UWordBreak>(m, "UWordBreak", py::arithmetic(),
                        ...
                        "word, to allow for further subdivisions of "
                        "a category in future releases. Applications should "
                        "check for tag values falling within the "
                        "range, rather than for single individual values.\n\n"
                        "The numeric values of all of these constants are "
      ...
      .value("UBRK_WORD_LETTER", UBRK_WORD_LETTER,
             ...
             "katakana or ideographic characters, lower "
             "limit.")
      ...
      .value(
          "UBRK_WORD_IDEO", UBRK_WORD_IDEO,
          "Tag value for words containing ideographic characters, lower limit.")
      .value(
          "UBRK_WORD_IDEO_LIMIT", UBRK_WORD_IDEO_LIMIT,
