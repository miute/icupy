...
void init_uidna(py::module &m) {
  ...
  m.attr("UIDNA_NONTRANSITIONAL_TO_ASCII") =
      int32_t{UIDNA_NONTRANSITIONAL_TO_ASCII};
  m.attr("UIDNA_NONTRANSITIONAL_TO_UNICODE") =
      int32_t{UIDNA_NONTRANSITIONAL_TO_UNICODE};
  ...
  m.attr("UIDNA_ERROR_DOMAIN_NAME_TOO_LONG") =
      int32_t{UIDNA_ERROR_DOMAIN_NAME_TOO_LONG};
  ...
  m.attr("UIDNA_ERROR_LEADING_COMBINING_MARK") =
      int32_t{UIDNA_ERROR_LEADING_COMBINING_MARK};
  ...
  m.attr("UIDNA_ERROR_INVALID_ACE_LABEL") =
      int32_t{UIDNA_ERROR_INVALID_ACE_LABEL};
  m.attr("UIDNA_ERROR_BIDI") = int32_t{UIDNA_ERROR_BIDI};
  m.attr("UIDNA_ERROR_CONTEXTJ") = int32_t{UIDNA_ERROR_CONTEXTJ};
  m.attr("UIDNA_ERROR_CONTEXTO_PUNCTUATION") =
      int32_t{UIDNA_ERROR_CONTEXTO_PUNCTUATION};
#if (U_ICU_VERSION_MAJOR_NUM >= 49)
