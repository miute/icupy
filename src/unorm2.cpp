...
void init_unorm2(py::module &m) {
  ...
  py::enum_<UNormalization2Mode>(
      ...
      "algorithms which are also used with custom "
      ...
      .value("UNORM2_COMPOSE", UNORM2_COMPOSE,
             ...
             "standard NFKC when using an \"nfkc\" "
             "instance. For details about standard Unicode normalization forms "
             "see "
             "http://www.unicode.org/unicode/reports/tr15/")
      .value("UNORM2_DECOMPOSE", UNORM2_DECOMPOSE,
             "Map, and reorder canonically.\n\n  "
             "Same as standard NFD when using an \"nfc\" instance. Same as "
             "standard NFKD when using an \"nfkc\" "
             "instance. For details about standard Unicode normalization forms "
             "see "
             "http://www.unicode.org/unicode/reports/tr15/")
      .value("UNORM2_FCD", UNORM2_FCD,
             ...
             "reordering would yield the same form as "
             "DECOMPOSE. Text in \"Fast C or D\" form can be processed "
             "efficiently with data tables that are "
             "\"canonically closed\", that is, that provide equivalent data "
             "for equivalent text, without having to be "
             "fully normalized. Not a standard Unicode normalization form. Not "
             "a unique form: Different FCD strings "
             "can be canonically equivalent. For details see "
             "http://www.unicode.org/notes/tn5/#FCD")
      .value("UNORM2_COMPOSE_CONTIGUOUS", UNORM2_COMPOSE_CONTIGUOUS,
             "Compose only contiguously.\n\n  "
             "Also known as \"FCC\" or \"Fast C Contiguous\". The result will "
             "often but not always be in NFC. The "
             "result will conform to FCD which is useful for processing. Not a "
  ...
  py::enum_<UNormalizationCheckResult>(
      ...
      .value(
          ...
          "when a backward-combining character "
          "is found for which the surrounding text would have to be analyzed "
          "further.")
      .export_values();
}
