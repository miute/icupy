...
void init_ucol(py::module &m) {
  ...
  py::enum_<UColAttribute>(m, "UColAttribute", py::arithmetic(),
                           ...
                           "All the attributes can take *UCOL_DEFAULT* value, "
      ...
      .value(
          ...
          "being considered backwards and "
      ...
      .value("UCOL_ALTERNATE_HANDLING", UCOL_ALTERNATE_HANDLING,
             ...
             "Acceptable values are *UCOL_NON_IGNORABLE* (default) which "
             "treats all the codepoints with non-ignorable "
             "primary weights in the same way, and *UCOL_SHIFTED* which causes "
             "codepoints with primary weights that "
             "are equal or below the variable top value to be ignored on "
             "primary level and moved to the quaternary "
             "level.")
      .value("UCOL_CASE_FIRST", UCOL_CASE_FIRST,
             "Controls the ordering of upper and lower case letters.\n\n  "
             "Acceptable values are *UCOL_OFF* (default), which orders upper "
             "and lower case letters in accordance to "
             "their tertiary weights, *UCOL_UPPER_FIRST* which forces upper "
             "case letters to sort before lower case "
      ...
      .value("UCOL_CASE_LEVEL", UCOL_CASE_LEVEL,
             ...
             "Acceptable values are *UCOL_OFF* (default), when case level is "
             "not generated, and *UCOL_ON* which causes "
             "the case level to be generated. Contents of the case level are "
             "affected by the value of "
             "*UCOL_CASE_FIRST* attribute. A simple way to ignore accent "
             "differences in a string is to set the "
      ...
      .value("UCOL_NORMALIZATION_MODE", UCOL_NORMALIZATION_MODE,
             ...
             "When set to *UCOL_OFF* (default) no normalization check is "
             "performed. The correctness of the result is "
             "guaranteed only if the input data is in so-called FCD form (see "
             "users manual for more info). When set to "
             "*UCOL_ON*, an incremental check is performed to see whether the "
             "input data is in the FCD form. If the "
             "data is not in the FCD form, incremental NFD normalization is "
             "performed.")
      .value("UCOL_DECOMPOSITION_MODE", UCOL_DECOMPOSITION_MODE,
             "An alias for *UCOL_NORMALIZATION_MODE* attribute.")
      .value("UCOL_STRENGTH", UCOL_STRENGTH,
             "The strength attribute.\n\n  "
             "Can be either *UCOL_PRIMARY*, *UCOL_SECONDARY*, *UCOL_TERTIARY*, "
             "*UCOL_QUATERNARY* or *UCOL_IDENTICAL*. "
             "The usual strength for most locales (except Japanese) is "
             "tertiary.\n\n  "
             "Quaternary strength is useful when combined with shifted setting "
             "for alternate handling attribute and "
             "for JIS X 4061 collation, when it is used to distinguish between "
             "Katakana and Hiragana. Otherwise, "
             "quaternary level is affected only by the number of non-ignorable "
      ...
      .value("UCOL_HIRAGANA_QUATERNARY_MODE", UCOL_HIRAGANA_QUATERNARY_MODE,
             "**Deprecated:** ICU 50 Implementation detail, cannot be set via "
             "API, was removed from implementation.")
      .value("UCOL_NUMERIC_COLLATION", UCOL_NUMERIC_COLLATION,
             ...
             "longest digit substring that can be treated "
             "as a single unit is 254 digits (not counting leading zeros). If "
             "a digit substring is longer than that, "
             "the digits beyond the limit will be treated as a separate digit "
             "substring.\n\n  "
             "A \"digit\" in this sense is a code point with "
             "General_Category=Nd, which does not include circled "
             "numbers, roman numerals, etc. Only a contiguous digit substring "
             "is considered, that is, non-negative "
  ...
  py::enum_<UColAttributeValue>(
      ...
      "Here are all the allowable values. Not every attribute can take every "
      "value. The only universal value is "
      "*UCOL_DEFAULT*, which resets the attribute value to the predefined "
  ...
  //
  py::enum_<UCollationResult>(
      m, "UCollationResult", py::arithmetic(),
      "*UCOL_LESS* is returned if source string is compared to be less than "
      "target string in "
      "the *ucol_strcoll()* method.\n\n"
      "*UCOL_EQUAL* is returned if source string is compared to be equal to "
      "target string in "
      "the *ucol_strcoll()* method. *UCOL_GREATER* is returned if source "
      "string is compared to "
  ...
  py::enum_<UColReorderCode>(
      ...
      "Enum containing the codes for reordering segments of the collation "
      "table that are not script codes.\n\n"
      "These reordering codes are to be used in conjunction with the script "
      "codes.")
      ...
      .value("UCOL_REORDER_CODE_OTHERS", UCOL_REORDER_CODE_OTHERS,
             "A special reordering code that is used to specify all other "
             "codes used for reordering except for the "
             "codes lised as *UColReorderCode* values and those listed "
             "explicitly in a reordering.")
      ...
      .value("UCOL_REORDER_CODE_FIRST", UCOL_REORDER_CODE_FIRST,
             ...
             "This is intended for use in range checking and enumeration of "
             "the reorder codes.")
  ...
  py::enum_<UColRuleOption>(m, "UColRuleOption", py::arithmetic(),
      ...
      .value("UCOL_FULL_RULES", UCOL_FULL_RULES,
             "Retrieves the \"UCA rules\" concatenated with the tailoring "
             "rules.\n\n  "
             "The \"UCA rules\" are an approximation of the root collator's "
             "sort order. They are almost never used or "
             "useful at runtime and can be removed from the data. See "
             "https://unicode-org.github.io/icu/userguide/collation/"
             "customization#building-on-existing-locales")
      .export_values();
}
