...
void init_udat(py::module &m) {
  ...
  py::enum_<UDateFormatBooleanAttribute>(m, "UDateFormatBooleanAttribute",
      ...
      .value("UDAT_PARSE_ALLOW_NUMERIC", UDAT_PARSE_ALLOW_NUMERIC,
             ...
             "assumed.\n\n  "
             "e.g.: *UDAT_YEAR_NAME_FIELD*, *UDAT_STANDALONE_MONTH_FIELD*, "
  ...
  py::enum_<UDateFormatField>(
      ...
      .value("UDAT_ERA_FIELD", UDAT_ERA_FIELD,
             "*FieldPosition* and *UFieldPosition* selector for 'G' field "
             "alignment, corresponding to the *UCAL_ERA* "
             "field.")
      .value("UDAT_YEAR_FIELD", UDAT_YEAR_FIELD,
             "*FieldPosition* and *UFieldPosition* selector for 'y' field "
             "alignment, corresponding to the *UCAL_YEAR* "
             "field.")
      .value("UDAT_MONTH_FIELD", UDAT_MONTH_FIELD,
             "*FieldPosition* and *UFieldPosition* selector for 'M' field "
             "alignment, corresponding to the *UCAL_MONTH* "
             "field.")
      .value("UDAT_DATE_FIELD", UDAT_DATE_FIELD,
             "*FieldPosition* and *UFieldPosition* selector for 'd' field "
             "alignment, corresponding to the *UCAL_DATE* "
             "field.")
      .value("UDAT_HOUR_OF_DAY1_FIELD", UDAT_HOUR_OF_DAY1_FIELD,
             "*FieldPosition* and *UFieldPosition* selector for 'k' field "
             "alignment, corresponding to the "
             "*UCAL_HOUR_OF_DAY* field.\n\n  "
             "*UDAT_HOUR_OF_DAY1_FIELD* is used for the one-based 24-hour "
             "clock. For example, 23:59 + 01:00 results in "
             "24:59.")
      .value("UDAT_HOUR_OF_DAY0_FIELD", UDAT_HOUR_OF_DAY0_FIELD,
             "*FieldPosition* and *UFieldPosition* selector for 'H' field "
             "alignment, corresponding to the "
             "*UCAL_HOUR_OF_DAY* field.\n\n  "
             "*UDAT_HOUR_OF_DAY0_FIELD* is used for the zero-based 24-hour "
             "clock. For example, 23:59 + 01:00 results "
             "in 00:59.")
      ...
      .value("UDAT_SECOND_FIELD", UDAT_SECOND_FIELD,
             "*FieldPosition* and *UFieldPosition* selector for 's' field "
             "alignment, corresponding to the "
             "*UCAL_SECOND* field.")
      .value("UDAT_FRACTIONAL_SECOND_FIELD", UDAT_FRACTIONAL_SECOND_FIELD,
             ...
             "significant digits for fractional "
             "seconds, corresponding to millisecond resolution and a "
             "fractional seconds sub-pattern of SSS. If the "
             "sub-pattern is S or SS, the fractional seconds value will be "
             "truncated (not rounded) to the number of "
             "display places specified. If the fractional seconds sub-pattern "
             "is longer than SSS, the additional "
             "display places will be filled with zeros.")
      .value("UDAT_DAY_OF_WEEK_FIELD", UDAT_DAY_OF_WEEK_FIELD,
             "*FieldPosition* and *UFieldPosition* selector for 'E' field "
             "alignment, corresponding to the "
      ...
      .value("UDAT_DAY_OF_WEEK_IN_MONTH_FIELD", UDAT_DAY_OF_WEEK_IN_MONTH_FIELD,
             "*FieldPosition* and *UFieldPosition* selector for 'F' field "
             "alignment, corresponding to the "
             "*UCAL_DAY_OF_WEEK_IN_MONTH* field.")
      .value("UDAT_WEEK_OF_YEAR_FIELD", UDAT_WEEK_OF_YEAR_FIELD,
             "*FieldPosition* and *UFieldPosition* selector for 'w' field "
             "alignment, corresponding to the "
      ...
      .value("UDAT_AM_PM_FIELD", UDAT_AM_PM_FIELD,
             "*FieldPosition* and *UFieldPosition* selector for 'a' field "
             "alignment, corresponding to the *UCAL_AM_PM* "
             "field.")
      .value("UDAT_HOUR1_FIELD", UDAT_HOUR1_FIELD,
             "*FieldPosition* and *UFieldPosition* selector for 'h' field "
             "alignment, corresponding to the *UCAL_HOUR* "
             "field.\n\n  "
             "*UDAT_HOUR1_FIELD* is used for the one-based 12-hour clock. For "
             "example, 11:30 PM + 1 hour results in "
             "12:30 AM.")
      ...
      .value("UDAT_TIMEZONE_FIELD", UDAT_TIMEZONE_FIELD,
             "*FieldPosition* and *UFieldPosition* selector for 'z' field "
             "alignment, corresponding to the "
      ...
      .value("UDAT_EXTENDED_YEAR_FIELD", UDAT_EXTENDED_YEAR_FIELD,
             "*FieldPosition* and *UFieldPosition* selector for 'u' field "
             "alignment, corresponding to the "
      ...
      .value("UDAT_TIMEZONE_GENERIC_FIELD", UDAT_TIMEZONE_GENERIC_FIELD,
             "*FieldPosition* and *UFieldPosition* selector for 'v' field "
             "alignment, corresponding to the "
             "*UCAL_ZONE_OFFSET* field.")
      .value("UDAT_STANDALONE_DAY_FIELD", UDAT_STANDALONE_DAY_FIELD,
             "*FieldPosition* selector for 'c' field alignment, corresponding "
             "to the *UCAL_DOW_LOCAL* field.\n\n  "
      ...
      .value("UDAT_QUARTER_FIELD", UDAT_QUARTER_FIELD,
             ...
             "This is implemented using the *UCAL_MONTH* field. This displays "
             "the quarter.")
      ...
      .value("UDAT_AM_PM_MIDNIGHT_NOON_FIELD", UDAT_AM_PM_MIDNIGHT_NOON_FIELD,
             ...
             "available; otherwise fall back to AM / "
             "PM.")
  ...
  py::enum_<UDateFormatSymbolType>(m, "UDateFormatSymbolType", py::arithmetic(),
      ...
      .value("UDAT_SHORT_WEEKDAYS", UDAT_SHORT_WEEKDAYS,
             "The CLDR-style format \"abbreviated\" (not \"short\") weekday "
             "names, for example \"Mon.\" For the "
             "CLDR-style format \"short\" weekday names, use "
      ...
      .value("UDAT_STANDALONE_SHORT_WEEKDAYS", UDAT_STANDALONE_SHORT_WEEKDAYS,
             "The CLDR-style stand-alone \"abbreviated\" (not \"short\") "
             "weekday names.\n\n  "
      ...
      .value("UDAT_CYCLIC_YEARS_WIDE", UDAT_CYCLIC_YEARS_WIDE,
             ...
             "for FORMAT usage; *udat_set_symbols* "
      ...
      .value("UDAT_NARROW_QUARTERS", UDAT_NARROW_QUARTERS,
      ...
      .value("UDAT_AM_PMS_NARROW", UDAT_AM_PMS_NARROW,
             "Narrow AM/PM names. For example: \"A\" and \"P\".")
      .value("UDAT_AM_PMS_WIDE", UDAT_AM_PMS_WIDE,
             "Wide AM/PM names. For example: \"Ante Meridiem\" and \"Post "
             "Meridiem\".")
