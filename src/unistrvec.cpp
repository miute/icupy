...
void init_unistrvec(py::module & /* m */,
                    py::class_<UnicodeStringVector> &usv) {
  //
  ...
  usv.def(py::init<>())
      ...
      .def(py::init([](const std::list<UnicodeString> &iterable) {
             return std::make_unique<UnicodeStringVector>(iterable.begin(),
                                                          iterable.end());
           }),
           py::arg("iterable"))
  ...
  usv.def("__bool__", [](const UnicodeStringVector &self) -> bool {
    return !self.empty();
  });

  usv.def(
      "__contains__",
      [](const UnicodeStringVector &self,
         const icupy::UnicodeStringVariant &item) {
        return std::find(self.begin(), self.end(), icupy::to_unistr(item)) !=
               self.end();
      },
      py::arg("item"));
  ...
  usv.def(
         ...
         [](UnicodeStringVector &self, int32_t index) {
           ...
           self.erase(self.begin() + normalized_index);
         },
         py::arg("index"))
      .def(
          "__delitem__",
  ...
  usv.def(
      "__eq__",
      [](const UnicodeStringVector &self, const UnicodeStringVector &other) {
        return self == other;
      },
      py::arg("other"));
  ...
  usv.def(
         "__iadd__",
         [](UnicodeStringVector &self,
            const icupy::UnicodeStringVariant &item) -> UnicodeStringVector & {
      ...
      .def(
          "__iadd__",
          [](UnicodeStringVector &self,
             const std::list<UnicodeString> &iterable)
              -> UnicodeStringVector & {
      ...
      .def(
          "__iadd__",
          [](UnicodeStringVector &self,
             const std::list<std::u16string> &iterable)
              -> UnicodeStringVector & {
  ...
  usv.def(
         ...
         [](UnicodeStringVector &self, int32_t index,
           ...
           self[actual_index] = icupy::to_unistr(item);
         },
  ...
  usv.def(
      ...
      [](UnicodeStringVector &self, int32_t index,
        ...
        self.insert(self.begin() + normalized_index, icupy::to_unistr(item));
      },
      py::arg("index"), py::arg("item"));
  ...
  usv.def(
      ...
      [](UnicodeStringVector &self, int32_t index) {
        ...
        auto result = std::move(self[normalized_index]);
        self.erase(self.begin() + normalized_index);
        return result;
      },
      py::arg("index") = -1);
  ...
  usv.def(
      ...
      [](UnicodeStringVector &self, const icupy::UnicodeStringVariant &item) {
        auto result =
            std::find(self.begin(), self.end(), icupy::to_unistr(item));
        if (result == self.end()) {
  ...
  usv.def("reverse", [](UnicodeStringVector &self) {
