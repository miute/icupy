...
void init_unumberformatter(py::module &m) {
  ...
  //
  py::enum_<UNumberDecimalSeparatorDisplay>(
      m, "UNumberDecimalSeparatorDisplay", py::arithmetic(),
      ...
      .value("UNUM_DECIMAL_SEPARATOR_AUTO", UNUM_DECIMAL_SEPARATOR_AUTO,
             ...
             "display after the separator, and do not "
             "show it otherwise.\n\n  "
  ...
  py::enum_<UNumberGroupingStrategy>(
      ...
      "separators (i.e., the separator, often a "
      "comma or period, after every 2-3 powers of ten).\n\n"
      "The choices are several pre-built strategies for different use cases "
      "that employ locale data whenever possible. "
      ...
      "The default is AUTO, which displays grouping separators unless the "
      "locale data says that grouping is not "
      "customary. To force grouping for all numbers greater than 1000 "
      "consistently across locales, use ON_ALIGNED. "
      "On the other hand, to display grouping less frequently than the "
      "default, use MIN2 or OFF. See the docs of "
      "each option for details.\n\n"
      "Note: This enum specifies the strategy for grouping sizes. To set which "
      "character to use as the grouping "
      ...
      .value("UNUM_GROUPING_MIN2", UNUM_GROUPING_MIN2,
             ...
             "grouping on values smaller than 10000 (such "
             "that there is a *minimum of two digits* before the first "
             "separator).\n\n  "
             "Note that locales may restrict grouping separators to be "
             "displayed only on 1 million or greater (for "
             "example, ee and hu) or disable grouping altogether (for example, "
             "bg currency).\n\n  "
             "Locale data is used to determine whether to separate larger "
             "numbers into groups of 2 (customary in South "
             "Asia) or groups of 3 (customary in Europe and the Americas).")
      .value(
          "UNUM_GROUPING_AUTO", UNUM_GROUPING_AUTO,
          "Display grouping using the default strategy for all locales.\n\n  "
          "This is the default behavior.\n\n  "
          "Note that locales may restrict grouping separators to be displayed "
          "only on 1 million or greater (for "
          "example, ee and hu) or disable grouping altogether (for example, bg "
          "currency).\n\n  "
          "Locale data is used to determine whether to separate larger numbers "
          "into groups of 2 (customary in South "
          "Asia) or groups of 3 (customary in Europe and the Americas).")
      .value("UNUM_GROUPING_ON_ALIGNED", UNUM_GROUPING_ON_ALIGNED,
             "Always display the grouping separator on values of at least "
             "1000.\n\n  "
             "This option ignores the locale data that restricts or disables "
             "grouping, described in MIN2 and AUTO. "
      ...
      .value("UNUM_GROUPING_THOUSANDS", UNUM_GROUPING_THOUSANDS,
             "Use the Western defaults: groups of 3 and enabled for all "
             "numbers 1000 or greater.\n\n  "
  ...
  py::enum_<UNumberRoundingPriority>(
      ...
      "An enum declaring how to resolve conflicts between maximum fraction "
      "digits and maximum significant digits.\n\n"
      "There are two modes, RELAXED and STRICT:\n\n"
      "* RELAXED: Relax one of the two constraints (fraction digits or "
      "significant digits) in order to round the "
      "number to a higher level of precision.\n"
      "* STRICT: Enforce both constraints, resulting in the number being "
      "rounded to a lower level of precision.\n\n"
      "The default settings for compact notation rounding are Max-Fraction = 0 "
      "(round to the nearest integer), "
      "Max-Significant = 2 (round to 2 significant digits), and priority "
      "RELAXED (choose the constraint that results "
      "in more digits being displayed).\n\n"
      "Conflicting minimum fraction and significant digits are always resolved "
      "in the direction that results in more "
      "trailing zeros.\n\n"
      "Example 1: Consider the number 3.141, with various different "
      "settings:\n\n"
      "* Max-Fraction = 1: \"3.1\"\n"
      "* Max-Significant = 3: \"3.14\"\n\n"
      "The rounding priority determines how to resolve the conflict when both "
      "Max-Fraction and Max-Significant are "
      "set. With RELAXED, the less-strict setting (the one that causes more "
      "digits to be displayed) will be used; "
      "Max-Significant wins. With STRICT, the more-strict setting (the one "
      "that causes fewer digits to be displayed) "
      "will be used; Max-Fraction wins.\n\n"
      "Example 2: Consider the number 8317, with various different "
      "settings:\n\n"
      "* Max-Fraction = 1: \"8317\"\n"
      "* Max-Significant = 3: \"8320\"\n\n"
      "Here, RELAXED favors Max-Fraction and STRICT favors Max-Significant. "
      "Note that this larger number caused the "
  ...
  py::enum_<UNumberSignDisplay>(
      ...
      "The exact format, including the position and the code point of the "
      "sign, differ by locale.")
      .value("UNUM_SIGN_AUTO", UNUM_SIGN_AUTO,
             "Show the minus sign on negative numbers, and do not show the "
             "sign on positive numbers.\n\n  "
             "This is the default behavior.\n\n  "
             "If using this option, a sign will be displayed on negative zero, "
             "including negative numbers that round "
             "to zero. To hide the sign on negative zero, use the NEGATIVE "
             "option.")
      ...
      .value("UNUM_SIGN_ACCOUNTING", UNUM_SIGN_ACCOUNTING,
             ...
             "and do not show the sign on positive "
             "numbers.\n\n  "
             "The accounting format is defined in CLDR and varies by locale; "
             "in many Western locales, the format is a "
             "pair of parentheses around the number.\n\n  "
             "Note: Since CLDR defines the accounting format in the monetary "
             "context only, this option falls back to "
             "the AUTO sign display strategy when formatting without a "
             "currency unit. This limitation may be lifted "
             "in the future.")
      .value("UNUM_SIGN_ACCOUNTING_ALWAYS", UNUM_SIGN_ACCOUNTING_ALWAYS,
             "Use the locale-dependent accounting format on negative numbers, "
             "and show the plus sign on positive "
             "numbers, including zero.\n\n  "
             "For more information on the accounting format, see the "
             "ACCOUNTING sign display strategy. To hide the "
  ...
  //
  py::enum_<UNumberTrailingZeroDisplay>(
      m, "UNumberTrailingZeroDisplay", py::arithmetic(),
      ...
      .value("UNUM_TRAILING_ZERO_HIDE_IF_WHOLE",
             ...
             "Same as AUTO, but hide trailing zeros after the decimal "
             "separator if they are all zero.")
      .export_values();
#endif // (U_ICU_VERSION_MAJOR_NUM >= 69)
  ...
  //
  py::enum_<UNumberUnitWidth>(
      m, "UNumberUnitWidth", py::arithmetic(),
      ...
      .value("UNUM_UNIT_WIDTH_NARROW", UNUM_UNIT_WIDTH_NARROW,
             ...
             "Similar to SHORT, but always use the shortest available "
             "abbreviation or symbol. This option can be "
             "used when the context hints at the identity of the unit. For "
             ...
             "measure units and the \"¤¤¤¤¤\" "
             "placeholder for currencies.")
      .value("UNUM_UNIT_WIDTH_SHORT", UNUM_UNIT_WIDTH_SHORT,
             "Print an abbreviated version of the unit name.\n\n  "
             "Similar to NARROW, but use a slightly wider abbreviation or "
             "symbol when there may be ambiguity. This "
             "is the default behavior.\n\n  "
             "For example, in *es-US*, the SHORT form for Fahrenheit is \"{0} "
             "°F\", but the NARROW form is "
             "\"{0}°\", since Fahrenheit is the customary unit for temperature "
             "in that locale.\n\n  "
             "In CLDR, this option corresponds to the \"Short\" format for "
             "measure units and the \"¤\" placeholder for "
             "currencies.")
      .value("UNUM_UNIT_WIDTH_FULL_NAME", UNUM_UNIT_WIDTH_FULL_NAME,
             "Print the full name of the unit, without any abbreviations.\n\n  "
             "In CLDR, this option corresponds to the default format for "
             "measure units and the \"¤¤¤\" placeholder for "
             "currencies.")
      ...
      .value("UNUM_UNIT_WIDTH_FORMAL", UNUM_UNIT_WIDTH_FORMAL,
             ...
             "\"NT$\" for the New Taiwan dollar in "
             "zh-TW.\n\n  "
      ...
      .value("UNUM_UNIT_WIDTH_HIDDEN", UNUM_UNIT_WIDTH_HIDDEN,
             ...
             "SHORT, but omit the currency symbol. For "
