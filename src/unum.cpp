...
void init_unum(py::module &m) {
  ...
  py::enum_<UNumberFormatAttribute>(
      ...
      .value("UNUM_SCALE", UNUM_SCALE,
             ...
             "formatted. The default value for the scale is "
             "0 (no adjustment).\n\n  "
             "Example: setting the scale to 3, 123 formats as \"123,000\"\n\n  "
             "Example: setting the scale to -4, 123 formats as \"0.0123\"\n\n  "
             "This setting is analogous to *get_multiplier_scale()* and "
             "*set_multiplier_scale()* in decimfmt.h.")
#endif // (U_ICU_VERSION_MAJOR_NUM >= 51)
#if (U_ICU_VERSION_MAJOR_NUM >= 64)
      .value(
          "UNUM_MINIMUM_GROUPING_DIGITS", UNUM_MINIMUM_GROUPING_DIGITS,
      ...
      .value("UNUM_PARSE_NO_EXPONENT", UNUM_PARSE_NO_EXPONENT,
             ...
             "doesn't contain an exponent, the exponent "
             "will not be parsed.\n\n  "
             "If the pattern does contain an exponent, this attribute has no "
             "effect. Has no effect on formatting. "
             "Default: 0 (unset)")
      ...
      .value("UNUM_PARSE_DECIMAL_MARK_REQUIRED",
             ...
             "if this attribute is set to 1, specifies that, if the pattern "
             "contains a decimal mark the input is "
             "required to have one.\n\n  "
             "If this attribute is set to 0, specifies that input does not "
             "have to contain a decimal mark. Has no "
  ...
  py::enum_<UNumberFormatMinimumGroupingDigits>(
      ...
      "Selectors with special numeric values to use locale default minimum "
      "grouping digits for the "
      "*DecimalFormat*/*UNumberFormat* *set_minimum_grouping_digits* "
      "method.\n\n"
      ...
      .value(
          ...
          "on values smaller than 10000 (such "
  ...
  //
  py::enum_<UNumberFormatPadPosition>(
      m, "UNumberFormatPadPosition", py::arithmetic(),
  ...
  py::enum_<UNumberFormatStyle>(m, "UNumberFormatStyle", py::arithmetic(),
      ...
      .value("UNUM_CURRENCY", UNUM_CURRENCY,
             ...
             "Defaults to *UNUM_CURRENCY_STANDARD* style (using currency "
             "symbol, e.g., \"$1.00\", with non-accounting "
             "style for negative values e.g. using minus sign). The specific "
             "style may be specified using the -cf- "
             "locale key.")
      ...
      .value("UNUM_SPELLOUT", UNUM_SPELLOUT,
             ...
             "*unum_set_text_attribute* with "
             "*UNUM_DEFAULT_RULESET*; the available public rulesets can be "
             "listed using *unum_get_text_attribute* "
      ...
      .value("UNUM_CURRENCY_ACCOUNTING", UNUM_CURRENCY_ACCOUNTING,
             ...
             "currency amount instead of \"-$3.00\" "
             "(*UNUM_CURRENCY*).\n\n  "
      ...
      .value("UNUM_CURRENCY_STANDARD", UNUM_CURRENCY_STANDARD,
             ...
             "non-accounting style for negative values "
             "(e.g., "
             "minus sign). Overrides any style specified using -cf- key in "
             "locale.")
  ...
  py::enum_<UNumberFormatTextAttribute>(
      ...
      .value("UNUM_DEFAULT_RULESET", UNUM_DEFAULT_RULESET,
             ...
             "*unum_get_text_attribute* with *UNUM_PUBLIC_RULESETS*. "
