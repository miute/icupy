...
void init_dtptngen(py::module &m) {
  ...
  //
  py::class_<DateTimePatternGenerator, UObject> dtpg(
      m, "DateTimePatternGenerator");

  dtpg.def("__copy__", &DateTimePatternGenerator::clone);

  dtpg.def(
      "__deepcopy__",
      [](const DateTimePatternGenerator &self, py::dict & /* memo */) {
        return self.clone();
      },
      py::arg("memo"));
  ...
  dtpg.def(
      "__eq__",
      [](const DateTimePatternGenerator &self,
         const DateTimePatternGenerator &other) { return self == other; },
  ...
  dtpg.def(
      "add_pattern",
      [](DateTimePatternGenerator &self,
         const icupy::UnicodeStringVariant &pattern, py::bool_ override,
         UnicodeString &conflicting_pattern) {
        ErrorCode error_code;
        auto result = self.addPattern(icupy::to_unistr(pattern), override,
                                      conflicting_pattern, error_code);
  ...
  dtpg.def_static(
          ...
          [](const icupy::LocaleVariant &locale) {
            ErrorCode error_code;
            auto result = DateTimePatternGenerator::createInstance(
  ...
  dtpg.def("get_append_item_format",
           &DateTimePatternGenerator::getAppendItemFormat, py::arg("field"));

  dtpg.def("get_append_item_name", &DateTimePatternGenerator::getAppendItemName,
           py::arg("field"));
  ...
  dtpg.def(
      ...
      [](DateTimePatternGenerator &self,
        ...
        ErrorCode error_code;
        auto result =
            self.getBaseSkeleton(icupy::to_unistr(pattern), error_code);
        if (error_code.isFailure()) {
          throw icupy::ICUError(error_code);
        }
        return result;
  ...
  dtpg.def(
          ...
          [](DateTimePatternGenerator &self,
            ...
            ErrorCode error_code;
            auto result = self.getBestPattern(icupy::to_unistr(skeleton),
                                              options, error_code);
            if (error_code.isFailure()) {
              throw icupy::ICUError(error_code);
            }
      ...
      .def(
          ...
          [](DateTimePatternGenerator &self,
            ...
            ErrorCode error_code;
            auto result =
                self.getBestPattern(icupy::to_unistr(skeleton), error_code);
            if (error_code.isFailure()) {
              throw icupy::ICUError(error_code);
            }
            return result;
  ...
  dtpg.def("get_date_time_format",
           py::overload_cast<>(&DateTimePatternGenerator::getDateTimeFormat,
                               py::const_))
      .def(
          "get_date_time_format",
          [](const DateTimePatternGenerator &self,
             UDateFormatStyle style) -> const UnicodeString & {
            ErrorCode error_code;
  ...
  dtpg.def("get_field_display_name",
           &DateTimePatternGenerator::getFieldDisplayName, py::arg("field"),
           py::arg("width"));
  ...
  dtpg.def(
      ...
      [](DateTimePatternGenerator &self,
         const icupy::UnicodeStringVariant &skeleton) -> const UnicodeString & {
  ...
  dtpg.def(
          ...
          [](DateTimePatternGenerator &self,
             ...
             UDateTimePatternMatchOptions options) {
            ErrorCode error_code;
            auto result = self.replaceFieldTypes(icupy::to_unistr(pattern),
                                                 icupy::to_unistr(skeleton),
                                                 options, error_code);
            if (error_code.isFailure()) {
              throw icupy::ICUError(error_code);
            }
      ...
      .def(
          ...
          [](DateTimePatternGenerator &self,
            ...
            ErrorCode error_code;
            auto result =
                self.replaceFieldTypes(icupy::to_unistr(pattern),
                                       icupy::to_unistr(skeleton), error_code);
            if (error_code.isFailure()) {
              throw icupy::ICUError(error_code);
            }
            return result;
  ...
  dtpg.def(
      ...
      [](DateTimePatternGenerator &self, UDateTimePatternField field,
  ...
  dtpg.def(
      ...
      .def(
          ...
          [](DateTimePatternGenerator &self, UDateFormatStyle style,
             const icupy::UnicodeStringVariant &date_time_format) {
            ErrorCode error_code;
            self.setDateTimeFormat(style, icupy::to_unistr(date_time_format),
                                   error_code);
            if (error_code.isFailure()) {
              throw icupy::ICUError(error_code);
            }
  ...
  dtpg.def(
      "set_decimal",
      [](DateTimePatternGenerator &self,
         const icupy::UnicodeStringVariant &decimal) {
  ...
  dtpg.def_static(
      ...
      [](const icupy::UnicodeStringVariant &pattern) {
        ErrorCode error_code;
        auto result = DateTimePatternGenerator::staticGetBaseSkeleton(
  ...
  dtpg.def_static(
      ...
      [](const icupy::UnicodeStringVariant &pattern) {
        ErrorCode error_code;
        auto result = DateTimePatternGenerator::staticGetSkeleton(
            icupy::to_unistr(pattern), error_code);
        if (error_code.isFailure()) {
          throw icupy::ICUError(error_code);
        }
