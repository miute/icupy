...
void init_schriter(py::module &m) {
  ...
  fci.def(
      "__eq__",
      [](const ForwardCharacterIterator &self,
         const ForwardCharacterIterator &other) { return self == other; },
  ...
  fci.def("has_next", [](ForwardCharacterIterator &self) -> py::bool_ {
    return self.hasNext();
  });

  fci.def("next32_post_inc", &ForwardCharacterIterator::next32PostInc);

  fci.def("next_post_inc", [](ForwardCharacterIterator &self) -> uint16_t {
    return self.nextPostInc();
  });
  ...
  ci.def("current", [](const CharacterIterator &self) -> uint16_t {
    return self.current();
  });
  ...
  ci.def("first",
         [](CharacterIterator &self) -> uint16_t { return self.first(); });

  ci.def("first32", &CharacterIterator::first32);

  ci.def("first32_post_inc", &CharacterIterator::first32PostInc);

  ci.def("first_post_inc", [](CharacterIterator &self) -> uint16_t {
    return self.firstPostInc();
  });
  ...
  ci.def("has_previous", [](CharacterIterator &self) -> py::bool_ {
    return self.hasPrevious();
  });

  ci.def("last",
         [](CharacterIterator &self) -> uint16_t { return self.last(); });

  ci.def("last32", &CharacterIterator::last32);

  ci.def("move", &CharacterIterator::move, py::arg("delta"), py::arg("origin"));

  ci.def("move32", &CharacterIterator::move32, py::arg("delta"),
         py::arg("origin"));

  ci.def("next",
         [](CharacterIterator &self) -> uint16_t { return self.next(); });

  ci.def("next32", &CharacterIterator::next32);

  ci.def("previous",
         [](CharacterIterator &self) -> uint16_t { return self.previous(); });

  ci.def("previous32", &CharacterIterator::previous32);

  ci.def(
      "set_index",
      [](CharacterIterator &self, int32_t position) -> uint16_t {
        return self.setIndex(position);
      },
      py::arg("position"));
  ...
  uci.def(
      "__deepcopy__",
      [](const UCharCharacterIterator &self, py::dict & /* memo */) {
        return self.clone();
      },
      py::arg("memo"));
  ...
  sci.def(py::init([](const icupy::UnicodeStringVariant &text_str) {
            return std::make_unique<StringCharacterIterator>(
                icupy::to_unistr(text_str));
          }),
          py::arg("text_str"))
      .def(py::init([](const icupy::UnicodeStringVariant &text_str,
                       int32_t text_pos) {
             return std::make_unique<StringCharacterIterator>(
                 icupy::to_unistr(text_str), text_pos);
           }),
           py::arg("text_str"), py::arg("text_pos"))
      .def(py::init([](const icupy::UnicodeStringVariant &text_str,
                       int32_t text_begin, int32_t text_end, int32_t text_pos) {
             return std::make_unique<StringCharacterIterator>(
                 icupy::to_unistr(text_str), text_begin, text_end, text_pos);
           }),
           py::arg("text_str"), py::arg("text_begin"), py::arg("text_end"),
           py::arg("text_pos"))
  ...
  sci.def(
      "__deepcopy__",
      [](const StringCharacterIterator &self, py::dict & /* memo */) {
        return self.clone();
      },
      py::arg("memo"));
  ...
  sci.def("__reversed__", [](StringCharacterIterator &self) {
    ...
    for (auto c = self.last32(); c != CharacterIterator::DONE;
         c = self.previous32()) {
      result.push_back(c);
    }
    return result;
  ...
  sci.def(
      ...
      [](StringCharacterIterator &self,
         const icupy::UnicodeStringVariant &new_text) {
