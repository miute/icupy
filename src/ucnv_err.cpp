...
_UConverterFromUCallbackPtr::_UConverterFromUCallbackPtr(
    const py::function &action)
    : action_(action) {}

_UConverterFromUCallbackPtr::~_UConverterFromUCallbackPtr() {}

void _UConverterFromUCallbackPtr::callback(const void *context,
  ...
  *error_code =
      action(value, args, code_units, length, code_point, reason, *error_code)
          .cast<UErrorCode>();
}
...
_UConverterToUCallbackPtr::_UConverterToUCallbackPtr(const py::function &action)
    : action_(action) {}

_UConverterToUCallbackPtr::~_UConverterToUCallbackPtr() {}

void _UConverterToUCallbackPtr::callback(const void *context,
...
void init_ucnv_err(py::module &m) {
  ...
  //
  py::class_<_UConverterToUCallbackPtr>(m, "UConverterToUCallbackPtr")
      .def(py::init<py::function>(), py::arg("action"));
  ...
  py::class_<UConverterFromUnicodeArgs>(m, "UConverterFromUnicodeArgs")
      .def_property_readonly("converter",
                             [](const UConverterFromUnicodeArgs &self) {
                               return _UConverterPtr(self.converter);
                             });
  ...
  m.attr("UCNV_FROM_U_CALLBACK_ESCAPE") =
      _UConverterFromUCallbackPtr(UCNV_FROM_U_CALLBACK_ESCAPE);
  m.attr("UCNV_FROM_U_CALLBACK_SKIP") =
      _UConverterFromUCallbackPtr(UCNV_FROM_U_CALLBACK_SKIP);
  m.attr("UCNV_FROM_U_CALLBACK_STOP") =
      _UConverterFromUCallbackPtr(UCNV_FROM_U_CALLBACK_STOP);
  m.attr("UCNV_FROM_U_CALLBACK_SUBSTITUTE") =
      _UConverterFromUCallbackPtr(UCNV_FROM_U_CALLBACK_SUBSTITUTE);

  m.attr("UCNV_TO_U_CALLBACK_ESCAPE") =
      _UConverterToUCallbackPtr(UCNV_TO_U_CALLBACK_ESCAPE);
  m.attr("UCNV_TO_U_CALLBACK_SKIP") =
      _UConverterToUCallbackPtr(UCNV_TO_U_CALLBACK_SKIP);
  m.attr("UCNV_TO_U_CALLBACK_STOP") =
      _UConverterToUCallbackPtr(UCNV_TO_U_CALLBACK_STOP);
  m.attr("UCNV_TO_U_CALLBACK_SUBSTITUTE") =
      _UConverterToUCallbackPtr(UCNV_TO_U_CALLBACK_SUBSTITUTE);
